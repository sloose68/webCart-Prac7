const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-rJQjFBBD.js","assets/FeatureLayer-JSWtiqX3.js","assets/FeatureLayer-C6eb42jv.css","assets/OutputColorHighlightOID.glsl-BxJmEDPX.js","assets/videoUtils-Dni4GfbP.js","assets/requestImageUtils-YJ6XlDAv.js","assets/basicInterfaces-N86vRvDz.js","assets/TextureFormat-1mYWTFa-.js","assets/BufferView-DesOVBSw.js","assets/mat4f64-q_b6UJoq.js","assets/Indices-Cc2MKvhB.js","assets/triangle-DC6wRd22.js","assets/sphere-D3q5SwsU.js","assets/mat3f64-B5o_lm6j.js","assets/vectorStacks-o84gZfM0.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-DJURsBkI.js","assets/VertexAttribute-BfkzOMLV.js","assets/glsl-Cj7KC756.js","assets/BindType-BBwFZqyN.js","assets/ShaderOutput-Bdd80V3g.js","assets/renderState-DJFWAOUr.js","assets/orientedBoundingBox-Bbkb2RbA.js","assets/quat-BPeam4y6.js","assets/spatialReferenceEllipsoidUtils-DT70ph4G.js","assets/computeTranslationToOriginAndRotation-Dr4Qu5AF.js","assets/plane-elzMcT1u.js","assets/boundedPlane-C1RwiXp2.js","assets/projectVectorToVector-DaitYwcv.js","assets/projectPointToVector-z6pLSDLo.js","assets/dehydratedFeatureUtils-C5MUjS7d.js","assets/meshVertexSpaceUtils-CuocyGlS.js","assets/MeshLocalVertexSpace-CCkLuSpw.js","assets/hydratedFeatures-TuUpycvb.js","assets/vec3f32-WCVSSNPR.js","assets/ShaderBuilder-CyINuXBw.js"])))=>i.map(i=>d[i]);
import{nH as Se,cO as Re,bC as ut,g9 as Pe,nI as dt,jm as Ae,nJ as ft,jN as pt,hg as ht,_ as gt,j6 as Fe,js as vt,a2 as P,l_ as Ie,hc as Xe,eD as le,am as G,eB as Y,aO as xe,ek as We,en as q,jE as pe,nK as ke,ar as Qe,aY as X,ez as te,eE as Ye,cr as mt,em as Ee,fc as St,bV as xt,h8 as bt,aK as Ct,ao as Ot,nL as $t,a_ as Tt}from"./FeatureLayer-JSWtiqX3.js";import{i as Pt,L as At,a as Et,m as yt,s as zt,b as Rt,e as Ft,c as It,o as wt,d as we,f as ge,g as _e,h as De,w as _t,t as Dt,j as Mt,k as H,l as jt,q as Lt,r as Nt,u as J,v as Bt,x as Ut,F as Vt,y as qt,z as Ht,A as Gt,B as Xt,C as A,D as Wt,E as Q,G as kt,H as Ze,I as Ke,J as Qt,K as Yt,M as Zt,N as Kt,O as Jt,R as eo,S as to,P as oo,Q as ao,T as Me,U as je,V as io,W as so,X as Le}from"./OutputColorHighlightOID.glsl-BxJmEDPX.js";import{e as Je}from"./mat3f64-B5o_lm6j.js";import{e as ro}from"./mat4f64-q_b6UJoq.js";import{s as no,g as lo,o as Ne,f as co,y as uo,T as Be}from"./BufferView-DesOVBSw.js";import{O as fo}from"./InterleavedLayout-CDEFagMB.js";import{n as N,u as et,w as ve}from"./ShaderOutput-Bdd80V3g.js";import{l as tt,u as po,n as ho,t as go,d as vo}from"./dehydratedFeatureUtils-C5MUjS7d.js";import{e as d}from"./VertexAttribute-BfkzOMLV.js";import{n as f,t as y}from"./glsl-Cj7KC756.js";import{a as mo}from"./BindType-BBwFZqyN.js";import{i as So}from"./ShaderBuilder-CyINuXBw.js";import{B as xo,o as bo,g as Co,p as Oo}from"./renderState-DJFWAOUr.js";let $o=class extends Pt{constructor(e,t){super(e,"vec4",mo.Draw,((a,i,s)=>a.setUniform4fv(e,t(i,s))))}};const ye=128,k=.5,fa=Se(k/2,k/2,1-k/2,1-k/2);function pa(o){return o==="cross"||o==="x"}function ha(o,e=ye,t=e*k,a=0){const{data:i,parameters:s}=To(o,e,t,a);return new At(i,s)}function To(o,e=ye,t=e*k,a=0){return{data:Po(o,e,t,a),parameters:{mipmap:!1,wrap:{s:Re.CLAMP_TO_EDGE,t:Re.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0,reloadable:!0}}}function Po(o,e=ye,t=e*k,a=0){switch(o){case"circle":default:return Ao(e,t);case"square":return Eo(e,t);case"cross":return zo(e,t,a);case"x":return Ro(e,t,a);case"kite":return yo(e,t);case"triangle":return Fo(e,t);case"arrow":return Io(e,t)}}function Ao(o,e){const t=o/2-.5;return ae(o,it(t,t,e/2))}function Eo(o,e){return ot(o,e,!1)}function yo(o,e){return ot(o,e,!0)}function zo(o,e,t=0){return at(o,e,!1,t)}function Ro(o,e,t=0){return at(o,e,!0,t)}function Fo(o,e){return ae(o,st(o/2,e,e/2))}function Io(o,e){const t=e,a=e/2,i=o/2,s=.8*t,r=it(i,(o-e)/2-s,Math.sqrt(s*s+a*a)),l=st(i,t,a);return ae(o,((u,n)=>Math.max(l(u,n),-r(u,n))))}function ot(o,e,t){return t&&(e/=Math.SQRT2),ae(o,((a,i)=>{let s=a-.5*o+.25,r=.5*o-i-.75;if(t){const l=(s+r)/Math.SQRT2;r=(r-s)/Math.SQRT2,s=l}return Math.max(Math.abs(s),Math.abs(r))-.5*e}))}function at(o,e,t,a=0){e-=a,t&&(e*=Math.SQRT2);const i=.5*e;return ae(o,((s,r)=>{let l,u=s-.5*o,n=.5*o-r-1;if(t){const S=(u+n)/Math.SQRT2;n=(n-u)/Math.SQRT2,u=S}return u=Math.abs(u),n=Math.abs(n),l=u>n?u>i?Math.sqrt((u-i)*(u-i)+n*n):n:n>i?Math.sqrt(u*u+(n-i)*(n-i)):u,l-=a/2,l}))}function it(o,e,t){return(a,i)=>{const s=a-o,r=i-e;return Math.sqrt(s*s+r*r)-t}}function st(o,e,t){const a=Math.sqrt(e*e+t*t);return(i,s)=>{const r=Math.abs(i-o)-t,l=s-o+e/2+.75,u=(e*r+t*l)/a,n=-l;return Math.max(u,n)}}function ae(o,e){const t=new Uint8Array(4*o*o);for(let a=0;a<o;a++)for(let i=0;i<o;i++){const s=i+o*a;let r=e(i,a);r=r/o+.5,ut(r,t,4*s)}return t}function wo(o){return o instanceof Float32Array&&o.length>=16}function _o(o){return Array.isArray(o)&&o.length>=16}function Do(o){return wo(o)||_o(o)}class Mo{constructor(){this.factor=new Ue,this.factorAlignment=new Ue}}class Ue{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function jo(o,e){const{vertex:t,fragment:a}=o;o.include(Et,e),t.include(tt),t.main.add(f`vec4 posProjCenter;
