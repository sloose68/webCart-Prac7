const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-C3GPqJNT.js","assets/index-C4I_fUP4.js","assets/OutputColorHighlightOID.glsl-CFyiRtm-.js","assets/videoUtils-CRfuTeY5.js","assets/requestImageUtils-fwS8fYJg.js","assets/basicInterfaces-N86vRvDz.js","assets/TextureFormat-1mYWTFa-.js","assets/BufferView-D6JhfiNJ.js","assets/mat4f64-q_b6UJoq.js","assets/Indices-C78i4sDe.js","assets/triangle-Fo2vBI9G.js","assets/sphere-BBFmkJym.js","assets/mat3f64-B5o_lm6j.js","assets/vectorStacks-xHxTx1Ui.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-CR3XySTw.js","assets/VertexAttribute-BfkzOMLV.js","assets/glsl-Cj7KC756.js","assets/BindType-BBwFZqyN.js","assets/ShaderOutput-Bdd80V3g.js","assets/renderState-C3IQJOgt.js","assets/orientedBoundingBox-BPZDYT7g.js","assets/quat-g8RUvCjX.js","assets/spatialReferenceEllipsoidUtils-BA1JfM09.js","assets/computeTranslationToOriginAndRotation-BCvC8w5A.js","assets/plane-BevxFgKZ.js","assets/boundedPlane-CB9IVKEi.js","assets/projectVectorToVector-LTzIS5mj.js","assets/projectPointToVector-QT0V0Ob9.js","assets/dehydratedFeatureUtils-D3NPa2ha.js","assets/meshVertexSpaceUtils-PdvDqnv9.js","assets/MeshLocalVertexSpace-DXz1kVLw.js","assets/hydratedFeatures-Cg0cZpqa.js","assets/vec3f32-WCVSSNPR.js","assets/ShaderBuilder-B2HQ4-qL.js"])))=>i.map(i=>d[i]);
import{nC as Se,cO as Re,bC as ut,g9 as Pe,nD as dt,jh as Ae,nE as ft,jI as pt,hb as ht,_ as gt,j1 as Fe,jn as vt,a2 as P,lV as Ie,h7 as Xe,eD as le,am as G,eB as Y,aO as xe,ek as We,en as q,jz as pe,nF as ke,ar as Qe,aY as X,ez as te,eE as Ye,cr as mt,em as Ee,fc as St,bV as xt,h3 as bt,aK as Ct,ao as Ot,nG as $t,a_ as Tt}from"./index-C4I_fUP4.js";import{i as Pt,L as At,a as Et,m as yt,s as zt,b as Rt,e as Ft,c as It,o as wt,d as we,f as ge,g as _e,h as De,w as _t,t as Dt,j as Mt,k as H,l as jt,q as Lt,r as Nt,u as J,v as Bt,x as Ut,F as Vt,y as qt,z as Ht,A as Gt,B as Xt,C as A,D as Wt,E as Q,G as kt,H as Ze,I as Ke,J as Qt,K as Yt,M as Zt,N as Kt,O as Jt,R as eo,S as to,P as oo,Q as ao,T as Me,U as je,V as io,W as so,X as Le}from"./OutputColorHighlightOID.glsl-CFyiRtm-.js";import{e as Je}from"./mat3f64-B5o_lm6j.js";import{e as ro}from"./mat4f64-q_b6UJoq.js";import{s as no,g as lo,o as Ne,f as co,y as uo,T as Be}from"./BufferView-D6JhfiNJ.js";import{O as fo}from"./InterleavedLayout-CLY10jMS.js";import{n as N,u as et,w as ve}from"./ShaderOutput-Bdd80V3g.js";import{l as tt,u as po,n as ho,t as go,d as vo}from"./dehydratedFeatureUtils-D3NPa2ha.js";import{e as d}from"./VertexAttribute-BfkzOMLV.js";import{n as f,t as y}from"./glsl-Cj7KC756.js";import{a as mo}from"./BindType-BBwFZqyN.js";import{i as So}from"./ShaderBuilder-B2HQ4-qL.js";import{B as xo,o as bo,g as Co,p as Oo}from"./renderState-C3IQJOgt.js";let $o=class extends Pt{constructor(e,t){super(e,"vec4",mo.Draw,((a,i,s)=>a.setUniform4fv(e,t(i,s))))}};const ye=128,k=.5,fa=Se(k/2,k/2,1-k/2,1-k/2);function pa(o){return o==="cross"||o==="x"}function ha(o,e=ye,t=e*k,a=0){const{data:i,parameters:s}=To(o,e,t,a);return new At(i,s)}function To(o,e=ye,t=e*k,a=0){return{data:Po(o,e,t,a),parameters:{mipmap:!1,wrap:{s:Re.CLAMP_TO_EDGE,t:Re.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0,reloadable:!0}}}function Po(o,e=ye,t=e*k,a=0){switch(o){case"circle":default:return Ao(e,t);case"square":return Eo(e,t);case"cross":return zo(e,t,a);case"x":return Ro(e,t,a);case"kite":return yo(e,t);case"triangle":return Fo(e,t);case"arrow":return Io(e,t)}}function Ao(o,e){const t=o/2-.5;return ae(o,it(t,t,e/2))}function Eo(o,e){return ot(o,e,!1)}function yo(o,e){return ot(o,e,!0)}function zo(o,e,t=0){return at(o,e,!1,t)}function Ro(o,e,t=0){return at(o,e,!0,t)}function Fo(o,e){return ae(o,st(o/2,e,e/2))}function Io(o,e){const t=e,a=e/2,i=o/2,s=.8*t,r=it(i,(o-e)/2-s,Math.sqrt(s*s+a*a)),l=st(i,t,a);return ae(o,((u,n)=>Math.max(l(u,n),-r(u,n))))}function ot(o,e,t){return t&&(e/=Math.SQRT2),ae(o,((a,i)=>{let s=a-.5*o+.25,r=.5*o-i-.75;if(t){const l=(s+r)/Math.SQRT2;r=(r-s)/Math.SQRT2,s=l}return Math.max(Math.abs(s),Math.abs(r))-.5*e}))}function at(o,e,t,a=0){e-=a,t&&(e*=Math.SQRT2);const i=.5*e;return ae(o,((s,r)=>{let l,u=s-.5*o,n=.5*o-r-1;if(t){const S=(u+n)/Math.SQRT2;n=(n-u)/Math.SQRT2,u=S}return u=Math.abs(u),n=Math.abs(n),l=u>n?u>i?Math.sqrt((u-i)*(u-i)+n*n):n:n>i?Math.sqrt(u*u+(n-i)*(n-i)):u,l-=a/2,l}))}function it(o,e,t){return(a,i)=>{const s=a-o,r=i-e;return Math.sqrt(s*s+r*r)-t}}function st(o,e,t){const a=Math.sqrt(e*e+t*t);return(i,s)=>{const r=Math.abs(i-o)-t,l=s-o+e/2+.75,u=(e*r+t*l)/a,n=-l;return Math.max(u,n)}}function ae(o,e){const t=new Uint8Array(4*o*o);for(let a=0;a<o;a++)for(let i=0;i<o;i++){const s=i+o*a;let r=e(i,a);r=r/o+.5,ut(r,t,4*s)}return t}function wo(o){return o instanceof Float32Array&&o.length>=16}function _o(o){return Array.isArray(o)&&o.length>=16}function Do(o){return wo(o)||_o(o)}class Mo{constructor(){this.factor=new Ue,this.factorAlignment=new Ue}}class Ue{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function jo(o,e){const{vertex:t,fragment:a}=o;o.include(Et,e),t.include(tt),t.main.add(f`vec4 posProjCenter;
