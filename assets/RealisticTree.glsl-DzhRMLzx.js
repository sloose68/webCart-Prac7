import{he as ta,j5 as Q,a$ as ra,j4 as Ee,ja as ia,gY as Ga,eQ as Y,b4 as E,ku as Da,_ as he,g1 as na,iU as se,W as c,X as Me,Y as ja,cs as ie,d8 as Fa,dc as Ve,de as Ra,dd as Va,cY as Ba,gS as Ha,iz as Wa,iN as Ua,cU as Ya,bl as I,ee as qa,mN as Ja,u6 as k,jj as Za,i_ as Be,jf as He,bB as ka,b6 as Xa,br as Ka,ez as Te,eM as Qa,eC as We,bn as eo,gW as ao}from"./ScaleRangeLayer-CkcnxI7v.js";import{O as oo}from"./InterleavedLayout-CnwoTp3j.js";import{n as w,u as ee,r as Ue,o as Se,t as to,C as ro}from"./ShaderOutput-Bdd80V3g.js";import{n as L,a as M,t as ve}from"./NormalAttribute.glsl-Bjarj0Tp.js";import{aY as io,aZ as no,a_ as j,a$ as so,b0 as lo,b1 as co,a8 as le,b2 as uo,b3 as mo,a1 as ho,ad as vo,b4 as po,g as D,k as ae,_ as V,aq as B,b5 as H,b as K,h as $,as as W,r as fo,e as go,b6 as xo,A as R,b7 as bo,ag as sa,d as la,aa as ca,aW as da,ae as wo,v as _e,x as pe,ac as ua,b8 as Mo,q as ce,aL as To,ah as So,ai as Ye,a5 as ye,l as yo,o as z,b9 as v,aK as Ie,a6 as ze,a7 as de,a2 as Co,ba as No,bb as $o,i as Ae,bc as Oo,c as zo,bd as ma,$ as ue,be as ha,ar as va,f as pa,a as fa,at as ga,ab as me,bf as xa,K as Eo,au as _o,ay as Io,F as Ao,az as Lo,aA as Po,aB as Go,av as Do,aw as jo,ax as Fo,z as Ro,B as G,C as m,D as Vo,E as Ce,aC as Bo,N as Ho,ap as Wo,aU as Uo,aD as Yo,O as qo,W as Jo}from"./OutputColorHighlightOID.glsl-DzI-_NNG.js";import{i as N,a as qe,e as oe,n as te}from"./basicInterfaces-N86vRvDz.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{B as Le,g as Pe,f as Zo}from"./renderState-6KIuIW1A.js";import{n as i,t as p}from"./glsl-Cj7KC756.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-G_dO87DI.js";import{e as Ge,r as q}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import"./boundedPlane-DmISpkDK.js";import"./sphere-C5msylEj.js";function ko(e){e.vertex.code.add(i`
...
return posClip;
    ...
    }`)}const ne=E();function Ta(e,a){a.hasSymbolColors?(e.include(ko),e.attributes.add(x.SYMBOLCOLOR,"vec4"),e.varyings.add("colorMixMode","mediump float"),e.vertex.code.add(i`int symbolColorMixMode;
vec4 getSymbolColor() {
...
}`)):r===1?(t.uniforms.add(new z("lightingAmbientSH_R",(({lighting:o})=>I(A,o.sh.r[0],o.sh.r[1],o.sh.r[2],o.sh.r[3]))),new z("lightingAmbientSH_G",(({lighting:o})=>I(A,o.sh.g[0],o.sh.g[1],o.sh.g[2],o.sh.g[3]))),new z("lightingAmbientSH_B",(({lighting:o})=>I(A,o.sh.b[0],o.sh.b[1],o.sh.b[2],o.sh.b[3])))),t.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):r===2&&(t.uniforms.add(new le("lightingAmbientSH0",(({lighting:o})=>Y(aa,o.sh.r[0],o.sh.g[0],o.sh.b[0]))),new z("lightingAmbientSH_R1",(({lighting:o})=>I(A,o.sh.r[1],o.sh.r[2],o.sh.r[3],o.sh.r[4]))),new z("lightingAmbientSH_G1",(({lighting:o})=>I(A,o.sh.g[1],o.sh.g[2],o.sh.g[3],o.sh.g[4]))),new z("lightingAmbientSH_B1",(({lighting:o})=>I(A,o.sh.b[1],o.sh.b[2],o.sh.b[3],o.sh.b[4]))),new z("lightingAmbientSH_R2",(({lighting:o})=>I(A,o.sh.r[5],o.sh.r[6],o.sh.r[7],o.sh.r[8]))),new z("lightingAmbientSH_G2",(({lighting:o})=>I(A,o.sh.g[5],o.sh.g[6],o.sh.g[7],o.sh.g[8]))),new z("lightingAmbientSH_B2",(({lighting:o})=>I(A,o.sh.b[5],o.sh.b[6],o.sh.b[7],o.sh.b[8])))),t.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const aa=E(),A=ia();function vt(e){e.code.add(i`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
...
inputs.averageAmbientRadiance = ambientLightIrradianceComponent[1] * (1.0 + GROUND_REFLECTANCE);`),t.code.add(i`
    ...
    `);break;case v.Simplified:case v.TerrainWithWater:ze(t),de(t),t.code.add(i`const float roughnessTerrain = 0.5;
...
return outColor;
}`);default:case v.COUNT:}}let gt=class extends Ae{constructor(a,t,r){super(a,"mat4",fe.Draw,((o,s,n,l)=>o.setUniformMatrix4fv(a,t(s,n,l))),r)}},xt=class extends Ae{constructor(a,t,r){super(a,"mat4",fe.Pass,((o,s,n)=>o.setUniformMatrix4fv(a,t(s,n))),r)}};function bt(e){e.fragment.uniforms.add(new xt("shadowMapMatrix",((a,t)=>t.shadowMap.getShadowMapMatrices(a.origin)),4)),$a(e)}function wt(e){e.fragment.uniforms.add(new gt("shadowMapMatrix",((a,t)=>t.shadowMap.getShadowMapMatrices(a.origin)),4)),$a(e)}function $a(e){const{fragment:a}=e;a.uniforms.add(new z("cascadeDistances",(t=>t.shadowMap.cascadeDistances)),new Oo("numCascades",(t=>t.shadowMap.numCascades))),a.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)}class Tt extends Ae{constructor(a,t){super(a,"sampler2DShadow",fe.Bind,((r,o)=>r.bindTexture(a,t(o))))}}function Oa(e,a){a.receiveShadows&&(e.include(bt),Ea(e))}function za(e,a){a.receiveShadows&&(e.include(wt),Ea(e))}function Ea(e){e.include(Mt);const{fragment:a}=e;a.uniforms.add(new Tt("shadowMap",(t=>t.shadowMap.depthTexture))),a.code.add(i`float readShadowMap(const in vec3 _worldPos, float _linearDepth) {
...
}`)):e.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function _a(e){e.include(zo),e.code.add(i`
