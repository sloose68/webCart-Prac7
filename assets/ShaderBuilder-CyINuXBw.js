import{D as w,d as l}from"./FeatureLayer-JSWtiqX3.js";import{a as c}from"./BindType-BBwFZqyN.js";const f=()=>w.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder");class S{constructor(){this._includedModules=new Map}include(e,n){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,n),e(this.builder,n))}}class k extends S{constructor(){super(...arguments),this.vertex=new b,this.fragment=new b,this.attributes=new E,this.varyings=new F,this.extensions=new p,this.outputs=new g}get fragmentUniforms(){return this.fragment.uniforms.entries}get builder(){return this}generate(e,n=!1){const t=this.extensions.generateSource(e),i=this.attributes.generateSource(e),a=this.varyings.generateSource(e),s=e==="vertex"?this.vertex:this.fragment,u=s.uniforms.generateSource(),d=s.code.generateSource(),$=s.main.generateSource(n),_=e==="vertex"?x:D,T=s.constants.generateSource(),v=this.outputs.generateSource(e);return`#version 300 es
${t.join(`
`)}
${_}
${T.join(`
