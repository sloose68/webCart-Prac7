import{a as y}from"./WGLContainer-DMvcxewb.js";import{E as A,o as X}from"./ProgramTemplate-BLx3mhyn.js";import{h4 as v,cK as c,cO as g,cN as p,iX as Q,cP as M,jf as I,j6 as P,cQ as R,cM as S}from"./FeatureLayer-JSWtiqX3.js";import{R as x}from"./FramebufferObject-qaKtKXNN.js";class d{constructor(s,e,r,n,u,E,a,_,T){this.createQuery=s,this.deleteQuery=e,this.resultAvailable=r,this.getResult=n,this.disjoint=u,this.beginTimeElapsed=E,this.endTimeElapsed=a,this.createTimestamp=_,this.timestampBits=T}}let i=!1;function D(t,s){if(s.disjointTimerQuery)return null;let e=t.getExtension("EXT_disjoint_timer_query_webgl2");return e?new d((()=>t.createQuery()),(r=>{t.deleteQuery(r),i=!1}),(r=>t.getQueryParameter(r,t.QUERY_RESULT_AVAILABLE)),(r=>t.getQueryParameter(r,t.QUERY_RESULT)),(()=>t.getParameter(e.GPU_DISJOINT_EXT)),(r=>{i||(i=!0,t.beginQuery(e.TIME_ELAPSED_EXT,r))}),(()=>{t.endQuery(e.TIME_ELAPSED_EXT),i=!1}),(r=>e.queryCounterEXT(r,e.TIMESTAMP_EXT)),(()=>t.getQuery(e.TIMESTAMP_EXT,e.QUERY_COUNTER_BITS_EXT))):(e=t.getExtension("EXT_disjoint_timer_query"),e?new d((()=>e.createQueryEXT()),(r=>{e.deleteQueryEXT(r),i=!1}),(r=>e.getQueryObjectEXT(r,e.QUERY_RESULT_AVAILABLE_EXT)),(r=>e.getQueryObjectEXT(r,e.QUERY_RESULT_EXT)),(()=>t.getParameter(e.GPU_DISJOINT_EXT)),(r=>{i||(i=!0,e.beginQueryEXT(e.TIME_ELAPSED_EXT,r))}),(()=>{e.endQueryEXT(e.TIME_ELAPSED_EXT),i=!1}),(r=>e.queryCounterEXT(r,e.TIMESTAMP_EXT)),(()=>e.getQueryEXT(e.TIMESTAMP_EXT,e.QUERY_COUNTER_BITS_EXT))):null)}class U{constructor(){this._result=!1}dispose(){this._program=v(this._program)}get result(){return this._program!=null&&(this._result=this._test(this._program),this.dispose()),this._result}}class j extends U{constructor(s){super(),this._rctx=s;const e=`
    ...
    `;this._program=s.programCache.acquire(e,r,new Map([["a_pos",0]]))}dispose(){super.dispose()}_test(s){const e=this._rctx;if(!e.gl)return s.dispose(),!0;const r=new c(1);r.wrapMode=g.CLAMP_TO_EDGE,r.samplingMode=p.NEAREST;const n=new x(e,r),u=A.createVertex(e,Q.STATIC_DRAW,new Uint16Array([0,0,1,0,0,1,1,1])),E=new X(e,new Map([["a_pos",0]]),y,new Map([["geometry",u]])),a=new c;a.samplingMode=p.LINEAR,a.wrapMode=g.CLAMP_TO_EDGE;const _=new M(e,a,o);e.useProgram(s),e.bindTexture(_,0),s.setUniform1i("u_texture",0);const T=e.getBoundFramebufferObject(),{x:m,y:h,width:f,height:w}=e.getViewport();e.bindFramebuffer(n),e.setViewport(0,0,1,1),e.setClearColor(0,0,0,0),e.setBlendingEnabled(!1),e.clear(I.COLOR),e.bindVAO(E),e.drawArrays(P.TRIANGLE_STRIP,0,4);const l=new Uint8Array(4);return n.readPixels(0,0,1,1,R.RGBA,S.UNSIGNED_BYTE,l),E.dispose(),n.dispose(),_.dispose(),e.setViewport(m,h,f,w),e.bindFramebuffer(T),l[0]!==255}}const o=new Image;o.src="data:image/svg+xml,%3C%3Fxml version='1.0' encoding='UTF-8'%3F%3E%3Csvg width='5' height='5' version='1.1' viewBox='0 0 5 5' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='5' height='5' fill='%23f00' fill-opacity='.5'/%3E%3C/svg%3E%0A",o.width=5,o.height=5,o.decode();export{D as a,j as f,U as t};
